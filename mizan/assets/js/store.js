/* ============================================================
   Mîzân — couche de stockage local (localStorage)
...
(function () {
  ...
  function lire(cle, defaut) {
    try {
      ...
      console.warn("Mîzân : lecture impossible", cle, e);
      return defaut;
    }
  }
  ...
  function ecrire(cle, valeur) {
    try {
      ...
      console.warn("Mîzân : écriture impossible", cle, e);
      return false;
    }
  }
  ...
  function exporterTout() {
    ...
    return { app: "Mîzân", version: 1, exporte: new Date().toISOString(), donnees: donnees };
  }
