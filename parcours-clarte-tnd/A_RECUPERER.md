...
> Le plus simple : **zipper le dossier source du site** (celui qui contient `f0_fondations`)
> et me l'envoyer — j'y récupère tout d'un coup (outils + images).

## 👪 Espace Parents — `f0_fondations/parents/`
