/* ============================================================
   Boussole Pro — couche de stockage local (localStorage)
   100% local : aucune donnée ne quitte l'appareil.
   Réutilise la philosophie du socle Boussole (ados).
   ============================================================ */
(function () {
  "use strict";

  var PREFIX = "boussole.pro.v1.";
  ...
  function lire(cle, defaut) {
    try {
      ...
      console.warn("Boussole Pro : lecture impossible", cle, e);
      return defaut;
    }
  }
  ...
  function ecrire(cle, valeur) {
    try {
      ...
      console.warn("Boussole Pro : écriture impossible", cle, e);
      return false;
    }
  }
  ...
  function exporterTout() {
    ...
    return { app: "Boussole Pro", version: 1, exporte: new Date().toISOString(), donnees: donnees };
  }
