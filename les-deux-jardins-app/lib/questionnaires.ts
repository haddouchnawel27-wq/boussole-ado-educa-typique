...
export const QUESTIONNAIRES: Questionnaire[] = [
  ...
  // 2 ───────── COLÈRE
  {
    ...
    questions: [
      ...
      { id: "c3", texte: "Je crie, j'insulte.", ...ECH },
  ...
  // 5 ───────── TRAUMATISME / CHOC ÉMOTIONNEL
  {
    ...
    univers: "jannat",
    introU: "Un repère sur les traces d'un événement difficile. Va à ton rythme — tu peux t'arrêter si c'est trop.",
    introI: "Un repère sur les traces d'un choc. Va à ton rythme, بِإِذْنِ اللّٰه — tu peux t'arrêter à tout moment si c'est trop.",
    questions: [
      ...
      { id: "tr6", texte: "Je me déconnecte de moi-même.", ...ECH },
  ...
  // 8 ───────── FAIBLESSE DE FOI / FUTŪR  (mode islamique UNIQUEMENT)
  {
    ...
    questions: [
      ...
      { id: "f9", texte: "« Allāh ne veut plus de moi. » / « Je ne suis pas digne. »", ...ECH },
